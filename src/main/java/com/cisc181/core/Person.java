...
public abstract class Person implements java.io.Serializable {
			...
			throws PersonException
	{
		...
		// Date constructor is deprecated, so using calendar instead
		Calendar cal = Calendar.getInstance();
		cal.set(1918, Calendar.MARCH, 18);   // March 18th 1918
		Date date_hundred = cal.getTime();
		
		if (DOB.before(date_hundred)) {
			throw new PersonException(this, "DOB given is more than 100"
